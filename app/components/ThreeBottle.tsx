export function ThreeBottle({ scale = 1 }: { scale?: number }) {
  return (
    <div className="relative mx-auto h-[420px] w-full max-w-sm" style={{ transform: `scale(${scale})` }}>
      <div className="absolute inset-x-12 bottom-8 top-14 animate-float rounded-[5rem] border border-white/70 bg-gradient-to-b from-white/80 via-cyan-100/35 to-purple-200/30 shadow-[0_30px_80px_rgba(83,36,123,.25)]">
