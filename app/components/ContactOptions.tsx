...
export function ContactOptions({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <div className="relative inline-flex">
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-3 w-64 overflow-hidden rounded-3xl border border-white/50 bg-white/95 p-3 text-slate-700 shadow-2xl backdrop-blur-xl" role="menu">
...
export function FloatingContact() {
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-white/30 bg-white/85 p-3 shadow-2xl backdrop-blur-xl md:hidden">
